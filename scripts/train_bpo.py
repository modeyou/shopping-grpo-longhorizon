...
def _overrides(args):
    ...
    return [f"trainer.logger={logger}", f"trainer.experiment_name={args.experiment_name}", *extra]
    ...
    environment.update(
        {
            ...
            "SHOPPING_GRPO_DIAGNOSTICS_PATH": str(output / "training_diagnostics.jsonl"),
...
def main():
    ...
    preflight = [sys.executable, str(ROOT / "scripts/check_bpo_runtime.py"), *_overrides(args)]
