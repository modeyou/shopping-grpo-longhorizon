...
BPO_DIAGNOSTIC_FIELDS = (
    ...
    "bpo_branch_action",
    "bpo_branch_entropy",
    "bpo_entropy_probe_sampled_token_id",
    "bpo_entropy_probe_argmax_token_id",
    "bpo_entropy_probe_sampled_token_text",
    "bpo_entropy_probe_argmax_token_text",
    "bpo_entropy_probe_argmax_token_type",
...
_SWANLAB_DASHBOARD_ALIASES = {
    ...
    "carl_budget/accepted_returns_total": "sampling/accepted_sibling_terminal_outcomes_total",
